...
public class ExDataSetController {
    ...
    @ResponseBody
    public R getSqlResult(@PathParam("dsId") String dsId,@PathParam("sql") String sql,@PathParam("orderByStr") String orderByStr){
    ...
    public R getSqlGroupResult(@RequestParam Map<String, Object> params){
    	...
    	if("table".equals(type)) {
    		...
    		data = d.getGroupList(dataSet.getSql(),columns, groups, new String[0],dataSet.getOrderByStr());
    	}
