    ...
    getJSONFileData("../../bddp/getBddpFolders", function (res) {
        if (res.code == 0) {
            ...
            for (var i = 0; i < fileArrs.length; i++) {
                var file = fileArrs[i];
                var ul = $('<ul class="lt-tr"><li class="lt-td uuid"></li><li class="lt-td image"></li><li class="lt-td filename"></li><li class="lt-td lasttime"></li><li class="lt-td ctrls"><span class="ctrl ctrl-edit">修改</span><span class="ctrl ctrl-del">删除</span></li></ul>');
                ...
                ul.find(".ctrl-edit").bind("click", function () {
                    window.open("design.html?uuid="+$(this).parents(".lt-tr").data("name"));
                    return false;
                });
                ul.find(".ctrl-del").bind("click", function () {
                    var path = $(this).parents(".lt-tr").data("path");
                    var pObj = $(this).parents(".lt-tr");
                    layx.confirm('消息提醒', '确认要删除“' + $(this).parents(".lt-tr").data("bdname") + '”？', function (id) {
                        getAjaxData("../../bddp/deleteBddpConfig", {
                            path: path
                        }, function (res) {
                            if (res.code == 0) {
                                pObj.remove();
